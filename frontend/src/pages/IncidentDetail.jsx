...
import { getIncident, updateIncident, investigateIncident } from '../api/incidents';
...
export default function IncidentDetail() {
  ...
  async function handleInvestigate() {
    ...
    try {
      ...
      setActionMsg(
        `AI investigation complete (${data.aiSource === 'openai' ? 'LLM' : 'evidence-based analysis'})`
      );
    } catch (err) {
    ...
    <div>
        ...
        {canEdit && (
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              disabled={investigating || incident.investigationStatus === 'running'}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <section className="bg-soc-surface border border-soc-border rounded-xl p-5">
            <h3 className="text-sm font-medium text-gray-300 mb-4">Agent Activity</h3>
            <AgentActivityPanel outputs={incident.agentOutputs} />
